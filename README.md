...
[Как получить YANDEX_API_KEY?](https://dvmn.org/encyclopedia/api-docs/yandex-geocoder-api/) Смотреть первый пункт.
...
- `YANDEX_API_KEY` — [см. документацию](https://dvmn.org/encyclopedia/api-docs/yandex-geocoder-api/)
